# Strapi plugin oEmbed (Forked)

> [!NOTE]
> This is a fork of `strapi-plugin-oembed-v2`. It includes fixes for:
>
> - Global style isolation issues in Strapi 5 Admin.
> - Tooltip errors causing plugin crashes.
